...
python pan_trainer.py --train_file /Users/cleoforman/PycharmProjects/bigmhc/data/el_mini.csv --val_file /Users/cleoforman/PycharmProjects/bigmhc/data/el_mini.csv --delimiter "," --pep_col pep --allele_col mhc --target_col tgt -f 2 -e 1 -lr 0.001 -d 0.1 -b 512 -pr 10 -dm 1 --decoy_ratio 1 --feat_sets /Users/cleoforman/PycharmProjects/hlathenav2/models/features/no_feats.txt --hla_encoding_file /Users/cleoforman/PycharmProjects/hlathenav2/hlathena/data/hla_seqs_onehot.csv --repetitions 1 -o ../output/test --run_name test --aa_feature_folder /Users/cleoforman/PycharmProjects/hlathenav2/models/features/aa_features
